...
public class smoModel {
    public static void main(String[] args) throws Exception {
        ...
        // Khởi tạo SMO với các tùy chọn mặc định (có thể tùy chỉnh thêm kernel)
        SMO smo = new SMO();

        long startTime = System.currentTimeMillis();
        smo.buildClassifier(train_data);
        Evaluation eval = new Evaluation(train_data);
        eval.crossValidateModel(smo, train_data, 10, new java.util.Random(1));
        long endTime = System.currentTimeMillis();
        double runtime = (endTime - startTime) / 1000.0;

        System.out.println("=== SMO Classifier (SVM) ===");
