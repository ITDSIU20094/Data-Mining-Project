...
public class RT {
    public static void main(String[] args) throws Exception {
        ...
        String[] options = {
                "-K", "0", // Number of attributes to randomly investigate. 0 = int(log_2(#attributes)+1)
                "-M", "1.0", // Minimum total weight of instances in a leaf
                "-depth", "0" // Max depth of the tree, 0 = unlimited
        };
        ...
        eval.crossValidateModel(tree, train_data, 10, new java.util.Random(1));
        long endTime = System.currentTimeMillis();
        double runtime = (endTime - startTime) / 1000.0;

        System.out.println("=== RandomTree Classifier ===");
